...
OPERATIONS_2 = ('about', 'across', 'after', 'against', 'among', 'at', 'before', 'between', 'by', 'down', 'from', 'in', 'off', 'on', 'over', 'through', 'to', 'under', 'up', 'with')
OPERATIONS_3 = ('as', 'for', 'of', 'till', 'than')
OPERATIONS_4 = ('a', 'the', 'all', 'any', 'every', 'little', 'much', 'no', 'other', 'some', 'such', 'that', 'this', 'I ', 'he', 'you', 'who')
OPERATIONS_5 = ('and', 'because', 'but', 'or', 'if', 'though', 'while', 'how', 'when', 'where', 'why')
